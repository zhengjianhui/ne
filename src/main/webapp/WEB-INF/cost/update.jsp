...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="/ne/action_cost_Find_up.html" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" value = "${cost.costType==1?checked:'' }"
                     id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" value = "${cost.costType==2?checked:'' }"
                     checked="checked" id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" value = "${cost.costType==3?checked:'' }" 
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" name = "descr" value = "">${cost.descr }</textarea>
